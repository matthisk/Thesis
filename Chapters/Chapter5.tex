...
\begin{lstlisting}[caption=Core syntax]
module core::Syntax
...
\begin{lstlisting}[caption=Swap statement syntax]
extend core::Syntax;
...
\begin{lstlisting}[caption=Swap statement desugar overload]
...
\begin{lstlisting}[caption=Desugar visitor]
...
\begin{lstlisting}[caption=Final desugar visitor]
Source runDesugar( Source pt ) {
	return solve(pt) {
		pt = visit(pt) {
