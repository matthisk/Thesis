...
Because language extensions in Rascal are nothing more than an extension of a module defining some base syntax, it is possible to extend language extensions. By good design it is possible to implement all ES6 language extensions without direct dependencies on each-other, only on the base grammar. But it can be seen as a serious limitation of other implementations that it is not possible to extend any of the defined language extensions. 
